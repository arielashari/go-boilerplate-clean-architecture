...
var (
	...
	ErrConflict           = NewAppError(CodeConflict, "resource already exists")
	ErrInvalidInput       = NewAppError(CodeValidation, "invalid input provided")
	ErrUnauthorized       = NewAppError(CodeUnauthorized, "unauthorized access")
	ErrForbidden          = NewAppError(CodeForbidden, "permission denied")
	ErrInvalidCredentials = NewAppError(CodeInvalidCreds, "invalid email or password")
	ErrEmailAlreadyExists = NewAppError(CodeEmailTaken, "email already exists")
